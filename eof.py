...
def plot_eofs(eofs):
    ...
    plt.savefig(working_directory+'/images/eof1.png',dpi=300,bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig(working_directory+'/images/eof2.png',dpi=300,bbox_inches='tight')
    plt.clf()
...
def plot_pcs_scatter(pcs):
    ...
    plt.ylim(-3, 3)
    plt.xlim(-3, 3)
    plt.savefig(working_directory+'/images/pcs.png',dpi=300,bbox_inches='tight')
    plt.clf()
...
def cluster(pcs):
    ...
    # plt.ylim(-3, 3)
    # plt.xlim(-3, 3)
    # plt.savefig(working_directory+'/images/kmeans_cluster.png',dpi=300,bbox_inches='tight')
...
for frame in range(0,121,24):
    ...
    filenames = [working_directory+'/gribs/500_f'+str(frame)+'.grib',working_directory+'/gribs/500_f'+str(frame+6)+'.grib',working_directory+'/gribs/500_f'+str(frame+12)+'.grib',working_directory+'/gribs/500_f'+str(frame+18)+'.grib']
    datasets = []
    ...
    plt.ylim(-3, 3)
    plt.xlim(-3, 3)
    plt.savefig(working_directory+'/images/pcs_kmeans.png',dpi=300,bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig(working_directory+'/images/clusters_f'+str(frame)+'.png',dpi=300,bbox_inches = 'tight')
    plt.clf()